...
if __name__ == '__main__':
    ...
    #   Generate reference
    x_ref = np.ones( (range) ) * 1   #np.linspace(0, 100, range)
    y_ref = np.ones( (range) ) * 0   #np.linspace(0, 100, range)
    yaw_ref = np.ones( (range) ) * 0.0
    
    pose = np.stack( [0, 0, 0, 0, 0, 0] )
    velocity = np.stack( [0, 0, 0, 0, 0, 0] )
    ...
    plt.figure()
    plt.plot( np.arange(range_aux + 1), velList[0::6] )
    plt.title('vx')

    plt.figure()
    plt.plot( np.arange(range_aux + 1), velList[1::6] )
    plt.title('vy')

    plt.figure()
    plt.plot( np.arange(range_aux + 1), velList[2::6] )
    plt.title('vz')

    plt.figure()
    plt.plot( np.arange(range_aux + 1), velList[3::6] )
    plt.title('wx')

    plt.figure()
    plt.plot( np.arange(range_aux + 1), velList[4::6] )
    plt.title('wy')

    plt.figure()
    plt.plot( np.arange(range_aux + 1), velList[5::6] )
    plt.title('wz')
