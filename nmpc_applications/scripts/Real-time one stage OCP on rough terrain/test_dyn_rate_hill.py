...
range_sim = 1500   #   Number of simulation iterations
...
if __name__ == '__main__':
    ...
    initial_state = next_state = np.stack( [ float( x_ref(progress_sol) ), float( y_ref(progress_sol) ), 0.0, 0.0, float( yaw_ref(progress_sol) ) + ca.pi, 0.0, 0.0, 0.0, 0.0] )
    ...
    if(saveData):
        ...
        figures_file = "/media/francisco/My_Passport/Universidade/IST_repositorio_pessoal/5_ano_2_sem/Tese_RoverNavigation_root/Tese_RoverNavigation/Resultados/Real-time one stage OCP on rough terrain/Map_" + str(map_option)
        ...
        with open(common.results_folder + "Real-time one stage OCP on rough terrain/Map_" + str(map_option) + "/" + str(index + 1) + ".json", "w") as f:
        ...
        with open(common.results_folder + "Real-time one stage OCP on rough terrain/Map_" + str(map_option) + "/sim_specs_" + str(index + 1) + ".json", "w") as f:
        ...
        with open(common.results_folder + "Real-time one stage OCP on rough terrain/Map_" + str(map_option) + "/solver_specs_" + str(index + 1) + ".json", "w") as f:
