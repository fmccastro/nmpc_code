...
if __name__ == '__main__':
    ...
    next_state = [ float( x_ref(0) ) + 0.5, float( y_ref(0) ) - 1.0, float( yaw_ref(0) ) + ca.pi/4, 0.0, 0.0, 0.0]
    ...
    with open(common.results_folder + "Initial_Comparison_nmpc/" + "mpcc.json", "w") as f:
