...
if __name__ == '__main__':
    ...
    markerReferencePath.ns = "reference"
    ...
    markerTruePoseRobot.header.frame_id = "map"
    markerKinematicsHorizonPath.header.frame_id = "map"
    markerDynamicsHorizonPath.header.frame_id = "map"
    markerReferencePath.header.frame_id ="map"
    ###
