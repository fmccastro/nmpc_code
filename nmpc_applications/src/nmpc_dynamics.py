...
if __name__ == '__main__':
    ...
    pub_command_fx = rospy.Publisher('/vehicle/nmpc_dynamics/fx', Float32, queue_size = 1)
    pub_command_mz = rospy.Publisher('/vehicle/nmpc_dynamics/mz', Float32, queue_size = 1)
