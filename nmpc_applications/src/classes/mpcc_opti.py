...
"""
    Build and define NMPC optimization problem with the MPCC formulation
"""
...
class ModelParameters(Common):
    ...
    def __init__(self):
        ...
        self.dynamics = ca.Function( 'dynamics_path_std', [x, y, yaw, vx, wz, virtual_speed, fl, fr, pitch], [ d_dynamics ] )
...
class Dynamics(ModelParameters, Common):
    def __init__(self, x_ref, y_ref, yaw_ref):
        ...
        for k in range( specs["N"] ):
            ...
            k2 = self.dynamics( self.x[k] + specs["Ts"] / 2 * k1[0],\
            ...
            k3 = self.dynamics( self.x[k] + specs["Ts"] / 2 * k2[0],\
            ...
            k4 = self.dynamics( self.x[k] + specs["Ts"] * k3[0],\
    ...
    def _setInitialState(self, initialState, param):
        ...
        self.opti.set_value( self.pitch, param["pitch"] )
        self.opti.set_value( self.roll, param["roll"] )
        self.opti.set_value( self.niu, param["friction"] )
        self.opti.set_value( self.fl_prev, param["fl_prev"] )
        self.opti.set_value( self.fr_prev, param["fr_prev"] )

        self.opti.set_value( self.fl_min, param["fl_min"] )
        self.opti.set_value( self.fl_max, param["fl_max"] )

        self.opti.set_value( self.fr_min, param["fr_min"] )
        self.opti.set_value( self.fr_max, param["fr_max"] )
    ...
    def _solve(self, initialState, prevSol, param):
        ...
        """ 
            ...
            :frictionCoefficient    friction coefficient considered for the mobile robot
        """
        ...
        self._setInitialState(initialState, param)
